        ...
        <StaggerReveal className='grid gap-6 sm:grid-cols-2' stagger={0.15}>
          {PROJECTS.map((project) => (
            <motion.div
              ...
              className='group rounded-2xl border border-card-border bg-card-bg p-6 transition-all hover:border-accent/40 hover:shadow-lg hover:shadow-accent/5 sm:p-8'
            >
